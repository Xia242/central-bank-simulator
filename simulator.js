        class EconomicEngine {
            constructor() {
                ...
                this.DANGER_HIGH = 6.0;        // High-inflation threshold
            ...
            reset() {
                ...
                // Responses per 1/60-second step; tuned for this game, not fitted to economic data.
                this.phillipsBeta = 0.008;
                this.rateSensitivity = 0.006;

                // Multiplicative noise per fixed step.
                this.inflationVolatility = 0.002;
                this.unemploymentVolatility = 0.001;
                this.drift = 0.0;
            ...
            /**
             * Apply multiplicative noise using coefficients for one fixed step.
             */
            applyMarketNoise(currentValue, drift, volatility) {
                // Standard normal sample; volatility already includes the fixed-step scale.
            ...
            /**
             * Approximate how unemployment and the policy rate affect each other.
             */
            applyPhillipsCurve() {
                ...
                // In this model, a higher policy rate increases unemployment.
                const unemploymentPressure = this.rateSensitivity * rateGap;

                // Pull both variables toward their baseline values.
            ...
            /**
             * Advance elapsed time in fixed steps, independently of rendering.
             */
            update(dt) {
            ...
            step(dt) {
                ...
                // Add multiplicative noise to each rate.
                this.inflation = this.applyMarketNoise(
                    this.inflation,
                    this.drift,
                    this.inflationVolatility
                );

                this.unemployment = this.applyMarketNoise(
                    this.unemployment,
                    this.drift,
                    this.unemploymentVolatility
                );

                // Keep rates within the game bounds.
        ...
        class PIDController {
            ...
            compute(currentInflation, dt) {
                ...
                // Above-target inflation calls for a rate above the neutral baseline.
        ...
        class Dashboard {
            ...
            initControls() {
                ...
                autopilotToggle.addEventListener('change', (e) => {
                    ...
                    if (this.autopilotEnabled) {
                        autopilotStatus.innerHTML = '<span>●</span> Automatic mode';
        ...
        class Simulator {
            ...
            gameLoop(currentTime) {
                ...
                const step = 1 / this.simulationHz;
